...
The mean number steps are `r sprintf("%.f", mean(steps_per_day$steps))` and the median `r sprintf("%.f", median(steps_per_day$steps))` of the total number of steps taken per day.
